...
local M = {
  ...
  Error = { fg = c.dark0, bg = c.red, bold = true },
  Todo = { fg = c.dark0, bg = c.light0, bold = true },
  Note = { fg = c.dark0, bg = c.bright_yellow, bold = true },
  ...
  DiagnosticSignError = { fg = c.bright_red, bg = c.bright_red },
  DiagnosticSignWarn = { fg = c.yellow, bg = c.yellow },
  DiagnosticSignInfo = { fg = c.blue, bg = c.blue },
  DiagnosticSignHint = { fg = c.aqua, bg = c.aqua },
  DiagnosticVirtualTextError = { fg = c.red, bg = c.red },
